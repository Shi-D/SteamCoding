			...
			<div class="layout-content-main">
				<div class="table-part">
					<div class="table-operate" id="operate">
			            ...
			            <button class="btn btn-primary" id="update-course" disabled>
						...
						<button class="btn btn-primary" id="boutique-course" data-toggle="modal" data-target="#boutique-course-modal" disabled>
							<i class="fa fa-plus-circle"></i>
							<span>设为精品课程</span>
						</button>
						
						<button class="btn btn-primary" id="cancel-boutique-course" data-toggle="modal" data-target="#cancel-boutique-course-modal" disabled>
							<i class="fa fa-times-circle"></i>
							<span>取消精品课程</span>
						</button>
						
						<div class="modal" id="boutique-course-modal" data-backdrop="static">
							<div class="modal-dialog">
								<div class="modal-content">
									...
									<div class="modal-body">
										<p>确认设置<span id="boutique-course-content" style="color:red"></span>为精品课程?</p>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
										<button type="button" class="btn btn-primary" data-dismiss="modal" id="boutique-course-commit">确定</button>
									</div>
								</div>
							</div>
						</div>
						
						<div class="modal" id="cancel-boutique-course-modal" data-backdrop="static">
							<div class="modal-dialog">
								<div class="modal-content">
									<div class="modal-header">
										<p>取消精品课程</p>
									...
									<div class="modal-body">
										<p>确认取消<span id="cancel-boutique-course-content" style="color:red"></span>为精品课程?</p>
									</div>
									<div class="modal-footer">
										<button type="button" class="btn btn-outline-secondary" data-dismiss="modal">取消</button>
										<button type="button" class="btn btn-primary" data-dismiss="modal" id="cancel-boutique-course-commit">确定</button>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="modal-dialog " >
								<div class="modal-content">
									...
									<div class="modal-footer">
										...
										<button type="button" class="btn btn-primary" data-dismiss="modal" id="createCourseCommit">添加</button>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="modal-dialog " >
								<div class="modal-content">
									...
									<div class="modal-body">
										...
										<textarea style="height: 140px" name="introduction"  class="form-control" id="modifyNewCourseIntroduction" placeholder="请输入课程介绍"></textarea>
							...
							<div class="modal-dialog modal-lg">
								<div class="modal-content">
									...
									<div class="modal-body" style="max-height:300px; overflow: auto;">
										<ul class="list-group" id="video-lib-list">
					...
					<div class="table-fliter">
						<div>
							<div>
								<label for="titleSearch">输入课程名或教师名以查找：</label>
...
<script src="../js/adminCourseManagement.js"></script>
</html>